...
MIN_NUM_VOXELS = 4
DIRECT_SURFACE_DIRECTION_PORE_RATIO = 0.7
DIRECT_SURFACE_DIRECTION_HUB_RATIO = 0.4
MIN_DIRECTIONAL_SURFACE_VOXELS = 24
...
DIRECT_SURFACE_COMPONENT_CONNECTIVITY_MODE = "custom18"
DIRECT_SURFACE_MOUTH_MERGE_GAP_VOXELS = 1
CAVITY_LIKE_POCKET_NECK_WIDTH_VOXELS = 1
CAVITY_LIKE_POCKET_CORE_TO_MOUTH_SHELL_RATIO = 500.0
