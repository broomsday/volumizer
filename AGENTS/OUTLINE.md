...
1. Continue CLI UX hardening: progress reporting, failure recovery behavior, and broader cluster selection controls (resume + baseline method/resolution filtering now implemented).
