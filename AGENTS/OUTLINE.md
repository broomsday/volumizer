...
1. Continue CLI UX hardening: richer progress/ETA reporting and broader cluster selection controls (resume + baseline method/resolution filtering + jobs/retries/metadata-cache support now implemented).
